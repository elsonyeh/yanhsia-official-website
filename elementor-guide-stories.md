...
<style>
  ...
  .yh-s-photo-pair-natural{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:12px 0;}
  ...
  .yh-s-photo-triple{display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin:12px 0;}
  ...
  .yh-s-obs-hero{margin:12px 0;}
  .yh-s-photo-pair{gap:8px;margin:12px 0;}
</style>
