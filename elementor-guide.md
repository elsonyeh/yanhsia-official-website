# 鹽夏不夜埕 — Elementor 匯入指南

> 圖片統一使用 GitHub Pages CDN：
> `https://elsonyeh.github.io/yanhsia-official-website/`
> 不需另外上傳圖片到 WordPress。
...
.yh-hero-bg {
  ...
  background: url('https://elsonyeh.github.io/yanhsia-official-website/%E9%BB%9E%E7%B6%B4%E7%89%A9/%E8%83%8C%E6%99%AF.png') center/cover no-repeat;
  opacity: .55; mix-blend-mode: screen;
}
.yh-hero-overlay {
  position: absolute; inset: 0;
  background: radial-gradient(ellipse 80% 70% at 50% 40%, rgba(192,84,108,.25) 0%, rgba(51,6,9,.75) 68%);
}
.yh-hero-content {
...
.yh-hero-eyebrow {
  font-size: 12px; letter-spacing: .5em; color: var(--gold);
  border: 1px solid rgba(242,190,92,.35);
...
.yh-hero-bomb-badge {
  ...
  display: flex; align-items: center; justify-content: center;
  box-shadow: 0 0 0 8px rgba(242,126,147,.25), 0 0 60px rgba(192,84,108,.4);
  animation: yh-pulse-ring 3s ease-in-out infinite;
}
.yh-hero-bomb-badge img { width: 175px; }
.yh-hero-tagline {
  font-family: 'Noto Serif TC', serif;
  font-size: 20px; color: var(--rose); letter-spacing: .25em;
}
.yh-hero-dates { display: flex; align-items: center; gap: 14px; }
.yh-date-pill {
  background: var(--gold); color: var(--primary);
  font-weight: 900; font-size: 17px;
  padding: 8px 22px; border-radius: 6px; letter-spacing: .05em;
  font-family: 'Noto Sans TC', sans-serif;
}
.yh-date-dash { color: var(--white); font-size: 20px; }
.yh-hero-location { font-size: 13px; letter-spacing: .22em; color: var(--gray); font-family: 'Noto Sans TC', sans-serif; }
.yh-hero-cta {
  margin-top: 6px; display: inline-block; padding: 14px 52px;
  background: var(--secondary); color: var(--white);
  text-decoration: none; font-weight: 700; font-size: 15px;
  letter-spacing: .12em; border-radius: 50px;
  transition: background .2s, transform .2s, box-shadow .2s;
  box-shadow: 0 4px 24px rgba(192,84,108,.4);
  font-family: 'Noto Sans TC', sans-serif;
}
...
.yh-hero-city {
  ...
  width: 100%; max-width: 980px; z-index: 7; pointer-events: none;
}
...
.yh-marquee-text {
  font-weight: 900; font-size: 17px;
  letter-spacing: .1em; padding-right: 64px; flex-shrink: 0;
  font-family: 'Noto Sans TC', sans-serif;
}
...
.yh-feat-desc { font-size: 13px; line-height: 1.9; opacity: .78; font-family: 'Noto Sans TC', sans-serif; }
...
.yh-founder-grid {
  ...
  gap: 32px; max-width: 800px; margin: 0 auto 80px;
}
...
.yh-founder-name {
  font-family: 'Noto Serif TC', serif;
  font-size: 26px; font-weight: 900; margin-bottom: 6px; color: var(--white);
}
.yh-founder-role { font-size: 12px; letter-spacing: .18em; color: var(--gold); margin-bottom: 16px; font-family: 'Noto Sans TC', sans-serif; }
.yh-founder-bio { font-size: 14px; line-height: 2.1; color: var(--gray); font-family: 'Noto Sans TC', sans-serif; }
.yh-book-badge {
  display: inline-block;
  background: rgba(242,190,92,.12);
  border: 1px solid rgba(242,190,92,.3);
  border-radius: 12px; padding: 18px 36px; margin-bottom: 80px;
}
.yh-book-badge span { font-family: 'Noto Serif TC', serif; font-size: 16px; color: var(--gold); }
.yh-video-label { font-size: 11px; letter-spacing: .4em; color: var(--gold); margin-bottom: 12px; font-family: 'Noto Sans TC', sans-serif; }
.yh-video-title {
  font-family: 'Noto Serif TC', serif;
...
.yh-video-wrap {
  ...
  box-shadow: 0 0 0 1px rgba(255,255,255,.1), 0 24px 60px rgba(0,0,0,.4);
}
...
.yh-line-sub { font-size: 15px; line-height: 2; color: rgba(51,6,9,.68); margin-bottom: 32px; font-family: 'Noto Sans TC', sans-serif; }

/* FOOTER */
.yh-footer-pre {
  background: var(--secondary); padding: 80px 48px;
  text-align: center; color: var(--white);
}
.yh-footer-pre-title {
  font-family: 'Noto Serif TC', serif;
  font-size: clamp(28px, 4vw, 48px); font-weight: 900; margin-bottom: 20px;
}
.yh-footer-pre-sub { font-size: 16px; opacity: .8; margin-bottom: 36px; font-family: 'Noto Sans TC', sans-serif; }
.yh-footer-pre-btn {
...
.yh-footer-copy { font-size: 12px; color: var(--gray); letter-spacing: .1em; font-family: 'Noto Sans TC', sans-serif; }

/* GRASS STRIP */
.yh-grass { position: relative; overflow: hidden; height: 100px; background: var(--bg); }
.yh-grass img {
  position: absolute; bottom: 0; left: 50%; transform: translateX(-50%);
  width: 100%; min-width: 900px; pointer-events: none;
}

/* 花轟頁專用 */
.yh-page-hero {
  background: var(--primary); padding: 160px 48px 80px;
...
.yh-page-hero-overlay {
  position: absolute; inset: 0;
  background: radial-gradient(ellipse 70% 60% at 50% 40%, rgba(192,84,108,.2) 0%, rgba(51,6,9,.8) 70%);
}
.yh-page-hero-inner { position: relative; z-index: 2; }
.yh-page-eyebrow { font-size: 11px; letter-spacing: .5em; color: var(--gold); margin-bottom: 16px; font-family: 'Noto Sans TC', sans-serif; }
.yh-page-title {
  font-family: 'Noto Serif TC', serif;
  font-size: clamp(48px, 7vw, 96px); font-weight: 900; color: var(--white); line-height: 1;
}
.yh-page-sub { margin-top: 16px; font-size: 15px; color: var(--rose); letter-spacing: .2em; font-family: 'Noto Sans TC', sans-serif; }
.yh-hero-badge {
  display: inline-flex; align-items: center; justify-content: center;
  background: var(--bg); border-radius: 50%;
  width: 160px; height: 160px; margin: 32px auto 0;
  box-shadow: 0 0 0 10px rgba(242,126,147,.2), 0 0 60px rgba(192,84,108,.35);
}
...
.yh-quote-block {
  font-family: 'Noto Serif TC', serif; font-size: 17px; line-height: 2.3;
  border-left: 3px solid var(--secondary); padding-left: 28px; margin-bottom: 24px; color: var(--white);
}
.yh-sub-text { font-size: 16px; line-height: 2.2; color: var(--rose); margin-bottom: 24px; font-family: 'Noto Sans TC', sans-serif; }
.yh-note-text { font-size: 14px; line-height: 2; opacity: .6; margin-bottom: 64px; font-family: 'Noto Sans TC', sans-serif; color: var(--white); }
...
.yh-trio-en { font-size: 11px; letter-spacing: .2em; opacity: .55; margin-bottom: 20px; font-family: 'Noto Sans TC', sans-serif; }
.yh-trio-body { font-size: 13px; line-height: 2.1; opacity: .88; font-family: 'Noto Sans TC', sans-serif; }
...
.yh-schedule-row {
  ...
  padding: 16px 0; border-bottom: 1px solid rgba(51,6,9,.1);
}
.yh-schedule-time { font-weight: 900; font-size: 15px; color: var(--primary); min-width: 80px; font-family: 'Noto Sans TC', sans-serif; }
.yh-schedule-name { font-weight: 700; font-size: 16px; margin-bottom: 3px; font-family: 'Noto Sans TC', sans-serif; }
.yh-schedule-stage { font-size: 12px; letter-spacing: .12em; color: var(--secondary); font-family: 'Noto Sans TC', sans-serif; }
...
.yh-info-box {
  background: rgba(242,190,92,.12); border: 1px solid rgba(242,190,92,.3);
  border-radius: 14px; padding: 30px 28px;
}
.yh-info-box-label { color: var(--gold); font-size: 11px; letter-spacing: .35em; margin-bottom: 10px; font-family: 'Noto Sans TC', sans-serif; }
.yh-info-box-value { font-family: 'Noto Serif TC', serif; font-size: 20px; font-weight: 700; line-height: 1.8; color: var(--white); }
.yh-info-box-value span { font-size: 15px; font-weight: 400; opacity: .75; font-family: 'Noto Sans TC', sans-serif; }
...
.yh-info-card-label { color: var(--gold); font-size: 11px; letter-spacing: .35em; margin-bottom: 14px; font-family: 'Noto Sans TC', sans-serif; }
.yh-info-list { display: flex; flex-direction: column; gap: 10px; }
.yh-info-list-item { display: flex; gap: 10px; font-size: 13px; line-height: 1.8; font-family: 'Noto Sans TC', sans-serif; color: var(--white); }
.yh-info-list-num { color: var(--secondary); flex-shrink: 0; }
.yh-info-plain { font-size: 13px; line-height: 2.2; opacity: .85; font-family: 'Noto Sans TC', sans-serif; color: var(--white); }
...
@keyframes yh-pulse-ring {
  0%,100% { box-shadow: 0 0 0 10px rgba(242,126,147,.18), 0 0 60px rgba(192,84,108,.35); }
  50%      { box-shadow: 0 0 0 18px rgba(242,126,147,.08), 0 0 80px rgba(192,84,108,.22); }
}
@keyframes yh-fadeUp {
...
### B. JS（Insert Headers and Footers 外掛 → Footer Scripts）
```html
<script>
  ...
  const mascots = document.querySelectorAll('.yh-mascot');
...
<section style="background:var(--primary);color:var(--white);padding:100px 48px;">
  <div style="max-width:1080px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;">
    <div class="yh-reveal">
      ...
      <p style="font-size:16px;line-height:2.1;color:var(--gray);font-family:'Noto Sans TC',sans-serif;">
        夏夜裡，花朵不睡覺。<br><br>
...
<section class="yh-curatorial">
  <div class="yh-curatorial-inner">
    ...
    <div class="yh-trio-grid yh-reveal">
      <div class="yh-trio-card" style="background:var(--secondary);">
